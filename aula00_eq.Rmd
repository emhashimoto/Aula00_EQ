...
&#10004; Dado as **boas condições** de regularidade, as aulas serão em **tempo real**. As gravações das aulas serão disponibilizadas posteriormente.
...
<http://www.utfpr.edu.br/estrutura-universitaria/pro-reitorias/prograd/legislacao/regulamento-disciplinar-2015>
...
&#10004; Será aprovado o aluno que obtiver média final maior ou igual a 6 $(MF\geq6)$, em que
		$$MF=\frac{P1+P2}{2} + BE,$$
em que $BE$ é o **bônus por engajamento** com a disciplina.

<br>

&#10004; O aluno com $MF<6$ deverá fazer a prova de recuperação (**matéria toda**) no dia 02-09-2021, que substituirá a **menor nota** entre $P1$ e $P2$. Em seguida, a média final será recalculada $(MF_{rec})$ considerando a nota da prova de recuperação. Então, a nota final será determinada pela expressão

$$NF=\min(6,MF_{rec}).$$
Será aprovado o aluno com $NF=6$.
...
&#10004; Disciplina: 2021 - S1 - Probabilidade e Estatística
...
**Eu vou conseguir** me dedicar a disciplina? 
